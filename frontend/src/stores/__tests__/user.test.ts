...
describe('User Store', () => {
  ...
  describe('initUser', () => {
    it('should initialize user from localStorage', () => {
      const mockUser = { id: '1', username: 'test', email: 'test@test.com', role: ['USER'], user_status: ['20'] }
  ...
  describe('isAdmin', () => {
    it('should return true when user has ADM role', () => {
      const mockUser = { id: '1', username: 'admin', email: 'admin@test.com', role: ['USER', 'ADM'], user_status: ['20'] }
      localStorage.setItem('token', 'mock-token')
      localStorage.setItem('user', JSON.stringify(mockUser))
    ...
    it('should return false when user does not have ADM role', () => {
      const mockUser = { id: '1', username: 'user', email: 'user@test.com', role: ['USER'], user_status: ['20'] }
      localStorage.setItem('token', 'mock-token')
      localStorage.setItem('user', JSON.stringify(mockUser))
