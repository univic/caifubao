...
registry = {
    ...
    "HFQ_PRICE_UPCROSS_MA_60": {
        "name": "HFQ_PRICE_UPCROSS_MA_60",
        "processor_object": moving_average.PriceMARelationProcessor,
        "handler": "run",
        "backtest_overall_anaylsis": True,
        "kwargs": {
            "PRI_MA": "MA_60",  # Primary MA line
            "CROSS_TYPE": "UP",  # price's relative position to primary MA line, ABOVE or BELOW
        },
        "factor_dependency": ["MA_60"],
        "type": "continuous",
