...
from app.lib.opportunity_seeker.processors.trading_opportunity_processor import (
    TradingOpportunityProcessor,
)
...
class MAOpportunityProcessor(TradingOpportunityProcessor):
    ...
    def prepare_input(self):
        logger.info(
            f"Reading signal data for {self.stock_obj.code} - {self.stock_obj.name}"
        )
