...
# service gives up with the original exit(1) contract.
...
class MongoWatcher:
    ...
    def connect_to_db(self, alias="default"):
        ...
        # MongoDB pod recreating — the 2026-08-28 backend crash-loop) does
        # not kill the service on the first probe. Keeps the original
