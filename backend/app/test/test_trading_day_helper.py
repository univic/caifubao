...
class TestTradingDayHelper(unittest.TestCase):
    ...
    def test_determine_closest_trading_date(self):
        ...
        act_result_1 = trading_day_helper.determine_closest_trading_date(
            trade_calendar=trade_calendar_list, given_time=given_input_1
        )
        ...
        act_result_2 = trading_day_helper.determine_closest_trading_date(
            trade_calendar=trade_calendar_list, given_time=given_input_2
        )
        ...
        act_result_3 = trading_day_helper.determine_closest_trading_date(
            trade_calendar=trade_calendar_list, given_time=given_input_3
        )
    ...
    def test_next_trading_day(self):
        ...
        act_result_1 = trading_day_helper.next_trading_day(
            trade_calendar=trade_calendar_list, given_time=given_input_1
        )
        self.assertEqual(act_result_1, exp_result_1)
