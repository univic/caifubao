...
class DatahubTask(object):
    ...
    def __init__(self):
        self.runner_name = 'General'
        self.task_obj = DataRetrieveTask
    ...
    def create_task(self, name, module, handler, args=None, kwarg_dict=None):
    ...
    def exec_task_list(self):
        ...
        for i, item in enumerate(task_list):
            ...
            if result['code'] == 'GOOD':
                ...
                counter["FAIL"] += 1
            prog_bar(i, task_list_length)
        logger.info(f'Processed {task_list_length} tasks, '
                    f'{counter["COMP"]} success, {counter["FAIL"]} failed.')
...
class ScheduledDatahubTask(DatahubTaskRunner):
    pass
