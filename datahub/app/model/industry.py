...
class IndustryDailyMetrics(Document):
    """
    Daily aggregated scoring metrics per Shenwan industry.

    One document per industry per date. Generated after each scoring run so
    that the industry_momentum component can reference the average score of
    ...
    meta = {
        ...
        "indexes": [
            {"fields": ["industry_code", "date"], "unique": True},
            ("date", "industry_code"),
            "-date",
        ],
    }
